...
class CrudProdutos(object):
    ...
    def EntradaProduto(self):
        ...
        try:
            c.execute(""" INSERT INTO entrada_produto VALUES ('{}', '{}',
                '{}', '{}', '{}', '{}') """
                      .format(self.idRelacao, self.idProduto,
                              self.qtdeProduto, self.valorCompra,
                              self.data, self.obsProduto))
            conecta.conecta.commit()
        except mysql.connector.Error as err:
            print("Erro Entrada Produto: '{}").format(err)
        pass
    ...
    def SaidaProduto(self):
        ...
        try:
            c.execute(""" INSERT INTO saida_produto VALUES ('{}', '{}', '{}',
                '{}') ON DUPLICATE KEY UPDATE  id_produto='{}', qtde='{}'"""
                      .format(self.idRelacao, self.idProduto,
                              self.qtdeProduto, self.data, self.idProduto,
                              self.qtdeProduto))
            conecta.conecta.commit()
        except mysql.connector.Error as err:
