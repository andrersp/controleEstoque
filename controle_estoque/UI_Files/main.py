...
#
# Created: Fri Feb  8 14:28:44 2019
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QtWidgets.QApplication.translate("MainWindow", "Azul e Rosa Personalizados", None, -1))
        self.lb_Data.setText(QtWidgets.QApplication.translate("MainWindow", "25/11", None, -1))
        self.lb_DiaSemana.setText(QtWidgets.QApplication.translate("MainWindow", "DOMINGO", None, -1))
        self.bt_Home.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Tela Inicial", None, -1))
        self.lb_NomeFantasia.setText(QtWidgets.QApplication.translate("MainWindow", "Titulo", None, -1))
        self.lb_NomeFantasia2.setText(QtWidgets.QApplication.translate("MainWindow", "Subtitulo", None, -1))
        self.bt_Exit.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Sair", None, -1))
        self.bt_MainProdutos.setToolTip(QtWidgets.QApplication.translate("MainWindow", "<html><head/><body><p>Produtos</p></body></html>", None, -1))
        self.bt_MainProdutos.setWhatsThis(QtWidgets.QApplication.translate("MainWindow", "<html><head/><body><p><br/></p></body></html>", None, -1))
        self.bt_MainProdutos.setText(QtWidgets.QApplication.translate("MainWindow", "Produtos", None, -1))
        self.bt_MainProdutos.setShortcut(QtWidgets.QApplication.translate("MainWindow", "F2", None, -1))
        self.bt_Vendas.setText(QtWidgets.QApplication.translate("MainWindow", "Vendas", None, -1))
        self.bt_Vendas.setShortcut(QtWidgets.QApplication.translate("MainWindow", "F3", None, -1))
        self.bt_Compras.setText(QtWidgets.QApplication.translate("MainWindow", "Compras", None, -1))
        self.bt_Compras.setShortcut(QtWidgets.QApplication.translate("MainWindow", "F7", None, -1))
        self.bt_Financeiro.setText(QtWidgets.QApplication.translate("MainWindow", "Financeiro", None, -1))
        self.bt_Financeiro.setShortcut(QtWidgets.QApplication.translate("MainWindow", "F5", None, -1))
        self.bt_Conf.setText(QtWidgets.QApplication.translate("MainWindow", "Configuração", None, -1))
        self.bt_Conf.setShortcut(QtWidgets.QApplication.translate("MainWindow", "F6", None, -1))
        self.bt_Clientes.setText(QtWidgets.QApplication.translate("MainWindow", "Clientes", None, -1))
